...
public class calculadora_Grafica extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        casilla.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 0, 204)));
        ...
        jTextArea1.setText("Programacion \nOrientada a\nObjeto Realizado por\nAuner Castillo");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(54, 54, 54)
                        .addComponent(casilla, javax.swing.GroupLayout.PREFERRED_SIZE, 289, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        int primernumero;
        operador = casilla.getText();
        primernumero = Integer.parseInt(operador);

        casilla.setText(String.valueOf(+ Math.pow(primernumero, 3)));
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        casilla.setText(String.valueOf(+ Math.pow(primernumero, 2)));
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        operador = casilla.getText();
        primernumero = Integer.parseInt(operador);
        calcular = Math.sqrt(primernumero);
        casilla.setText(String.valueOf(calcular));
    }//GEN-LAST:event_jButton9ActionPerformed

    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        this.segundonumero=Float.parseFloat(this.casilla.getText());
        switch(this.operador){
            case "+":this.casilla.setText(decimales(this.primernumero+this.segundonumero));break;
            case "-":this.casilla.setText(decimales(this.primernumero-this.segundonumero));break;
            case "*":this.casilla.setText(decimales(this.primernumero*this.segundonumero));break;
            case "/":this.casilla.setText(decimales(this.primernumero/this.segundonumero));break;
            case "a^2":this.casilla.setText(decimales(this.primernumero*this.primernumero));break;
            case "a^b": casilla.setText(String.valueOf(+ Math.pow(primernumero,segundonumero)));break;
            case "a/b":this.casilla.setText(decimales(this.primernumero/this.segundonumero));break;
